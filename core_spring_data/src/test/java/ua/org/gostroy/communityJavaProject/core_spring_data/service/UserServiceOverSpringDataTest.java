...
public class UserServiceOverSpringDataTest {
    private final Logger LOG = LoggerFactory.getLogger(getClass());
    User testUser;

    @Autowired
    UserServiceOverSpringData userService;

    @Before
    public void setup() {
        testUser = new User();
        testUser.setLogin("core_spring_data:testSetup");
    ...
    @Test
    public void update() {
        testUser.setLogin("core_spring_data:testUpdate");
    ...
    @Test
    public void save() {
        testUser.setLogin("core_spring_data:testSave");
