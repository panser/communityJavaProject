...
<body>
<p>This page makes sure we can retrieve the application, session
    and request attributes set in the previous page. <br/>
</p>
...
<p><a href="buggy.jsp">This hyperlink points to a JSP that will
