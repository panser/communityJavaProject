...
DROP SEQUENCE "BEANS_CONFIG".CORE_USERS$SEQ;
CREATE SEQUENCE  "BEANS_CONFIG"."CORE_USERS$SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE;
