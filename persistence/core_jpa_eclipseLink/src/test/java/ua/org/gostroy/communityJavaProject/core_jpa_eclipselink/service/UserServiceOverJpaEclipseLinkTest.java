...
@ContextConfiguration({"classpath:/ua/org/gostroy/communityJavaProject/core_jpa_eclipselink/applicationContext.xml"})
public class UserServiceOverJpaEclipseLinkTest {
    private final Logger LOG = LoggerFactory.getLogger(getClass());
    User testUser;

    @Autowired
    UserServiceOverJpaEclipseLink userService;

    @Before
    public void setup(){
        testUser = new User();
        testUser.setLogin("core_jpa_eclipseLink:testSetup");
    ...
    @Test
    public void update(){
        testUser.setLogin("core_jpa_eclipseLink:testUpdate");
    ...
    @Test
    public void save(){
        testUser.setLogin("core_jpa_eclipseLink:testSave");
