...
public class MoneyToStrOrig {
     ...
     */
    public MoneyToStrOrig(Currency currency, Language language, Pennies pennies) {
        if (currency == null) {
     ...
     */
    public MoneyToStrOrig(Currency currency, Language language, Pennies pennies, String[] names) {
        if (currency == null) {
            throw new IllegalArgumentException("currency is null");
        }
        if (language == null) {
    ...
    public static String percentToStr(Double amount, Language lang, Pennies pennies) {
        ...
        if (amount.floatValue() == amount.intValue()) {
            result = new MoneyToStrOrig(Currency.PER10, lang, pennies).convert(amount.longValue(), 0L);
            ...
            result = new MoneyToStrOrig(Currency.PER10, lang, pennies).convert(intPart, fractPart);
            ...
            result = new MoneyToStrOrig(Currency.PER100, lang, pennies).convert(intPart, fractPart);
            ...
            result = new MoneyToStrOrig(Currency.PER1000, lang, pennies).convert(intPart, fractPart);
        } else {
            fractPart = Math.round((amount - intPart) * NUM10000);
            result = new MoneyToStrOrig(Currency.PER10000, lang, pennies).convert(intPart, fractPart);
        }
        return result;
    }
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            ...
            String result = new MoneyToStrOrig(Currency.valueOf(currency), Language.valueOf(language), Pennies.valueOf(pennies)).convert(Double.valueOf(amount));
